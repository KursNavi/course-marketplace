...
const SuccessView = ({ setView, t = {} }) => (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full border border-green-100 text-center">
            ...
            <p className="text-gray-600 mb-4 font-sans">{t.booking_thanks || 'Danke für deine Buchung. Du erhältst in Kürze eine Bestätigungs-E-Mail.'}</p>
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6 text-left">
                <div className="flex items-start gap-2">
                    <Info className="w-5 h-5 text-orange-500 flex-shrink-0 mt-0.5" />
                    <p className="text-sm text-gray-700">
                        {t.booking_success_note || 'Kostenlose Stornierung ist je nach Kursart und Termin bis zu 7 Tage nach Buchung bzw. gemäss den Stornobedingungen vor dem Termin möglich. Details findest du im Dashboard.'}
                    </p>
                </div>
            </div>
