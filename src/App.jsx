    ...
    const applySession = async (session) => {
      ...
      if (session?.user) {
        ...
        let { data } = await supabase
          .from('profiles')
          .select('preferred_language, is_professional, package_tier, role, full_name, credit_balance_cents, email, stripe_connect_onboarding_complete')
        ...
        if (!data) {
          ...
          const { data: created } = await supabase
            ...
            .select('preferred_language, is_professional, package_tier, role, full_name, credit_balance_cents, stripe_connect_onboarding_complete')
            .single();
          ...
          setUser((prev) =>
            prev
              ? {
                  ...
                  stripe_connect_onboarding_complete: data.stripe_connect_onboarding_complete || false
                }
              : prev
          );
        }
  ...
  // --- RENDER ---
    ...
    <ErrorBoundary>
      ...
      {!loading && view === 'home' && (
         ...
         {view === 'landing-prof' && ( <LandingView title={t.landing_prof_title} subtitle={t.landing_prof_sub} variant="prof" searchQuery={searchQuery} setSearchQuery={setSearchQuery} handleSearchSubmit={handleSearchSubmit} setView={setView} setSearchType={setSearchType} t={t} /> )}
