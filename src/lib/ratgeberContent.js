 ...
 *
 * HTML content for all ratgeber articles.
 * Organized by category > cluster > article slug.
 */

export const RATGEBER_CONTENT = {
  // ============================================
  // BERUFLICH > FINANZIERUNG & FÖRDERUNG
  // ============================================
  'beruflich/finanzierung/vollkostenrechnung-weiterbildung': `
    ...
    <table>
      <thead>
        <tr><th>Abschlussart</th><th>Durchschnittliche Kosten</th><th>Bundesunterstützung</th></tr>
      </thead>
      <tbody>
        <tr><td>Fachausweis (BP)</td><td>CHF 5'000 – 13'200</td><td>Max. 50% (bis CHF 9'500)</td></tr>
        <tr><td>Höheres Diplom (HFP)</td><td>CHF 15'000 – 18'500</td><td>Max. 50% (bis CHF 10'500)</td></tr>
        <tr><td>MAS/CAS-Programme</td><td>CHF 12'000 – 40'000</td><td>Keine Bundesfinanzierung</td></tr>
      </tbody>
    </table>
  ...
  'beruflich/finanzierung/bundesbeitraege-50-prozent': `
    ...
    <h2>ROI-Berechnung: Wie schnell rentiert sich der Kurs?</h2>
    <p>Beispiel Fachausweis mit CHF 10'000 Kurskosten:</p>
    <ul>
      <li>Kurskosten: CHF 10'000</li>
      <li>Bundesbeitrag (50 %): CHF 5'000</li>
      <li>Dein Eigenbeitrag: CHF 5'000</li>
      <li>Durchschnittlicher Gehaltsanstieg nach Fachausweis: CHF 3'000–5'000/Jahr</li>
    </ul>
    <p><strong>Resultat: Break-even bereits nach 1–2 Jahren erreicht!</strong></p>
  `,
  ...
  'beruflich/finanzierung/kantonale-stipendien-vergleich': `
    ...
    <table>
      ...
      <tbody>
        <tr><td>Geldgeber</td><td>Bund (SBFI)</td><td>Kanton</td></tr>
        <tr><td>Zielgruppe</td><td>Alle mit bestandener Prüfung</td><td>Bedürftige Personen</td></tr>
        <tr><td>Voraussetzung</td><td>Eidg. Prüfung absolviert</td><td>Finanzielle Bedürftigkeit + Wohnsitz</td></tr>
        <tr><td>Höhe</td><td>Pauschal (CHF 9'500–10'500)</td><td>Variabel (CHF 500–5'000/Jahr)</td></tr>
        <tr><td>Typ</td><td>Zuschuss (Rückzahlung nicht nötig)</td><td>Zuschuss oder Darlehen</td></tr>
        <tr><td>Dauer</td><td>1x pro bestandene Prüfung</td><td>Während ganzer Weiterbildung</td></tr>
      </tbody>
    </table>
    ...
    <table>
      ...
      <tbody>
        <tr><td>Max. Zuschuss/Jahr</td><td>CHF 3'500</td><td>CHF 4'000</td><td>CHF 2'500</td></tr>
        <tr><td>Max. Darlehen</td><td>CHF 20'000</td><td>CHF 30'000</td><td>CHF 10'000</td></tr>
        <tr><td>Darlehenszins</td><td>1–2 %</td><td>0 % (zinslos)</td><td>1–2 %</td></tr>
        <tr><td>Umschulungen</td><td>Ja, oft gefördert</td><td>Ja, auch ältere</td><td>Oft NICHT</td></tr>
        <tr><td>Gesamteindruck</td><td>Liberal, schnell</td><td>Stringent, zinsfrei</td><td>Restriktiv</td></tr>
      </tbody>
    </table>
  ...
  'beruflich/finanzierung/weiterbildungsvereinbarungen': `
    ...
    <table>
      ...
      <tbody>
        <tr><td>Während Weiterbildung</td><td>unbegrenzt</td><td>Arbeitgeber trägt noch Kosten</td></tr>
        <tr><td>Nach Kursabschluss</td><td>1–3 Jahre max.</td><td>Loyalität aufgebaut</td></tr>
        <tr><td>Bei Kündigung durch AG</td><td>WEGFALL</td><td>Rückzahlungsanspruch entfällt</td></tr>
        <tr><td>Bei Kündigung durch AN</td><td>1–3 Jahre (reduzierend)</td><td>Abhängig von Vertrag</td></tr>
        <tr><td>Bei Invalidität/Alter</td><td>Oft WEGFALL</td><td>Soziale Gerechtigkeit</td></tr>
      </tbody>
    </table>
    ...
    <ul>
      ...
      <li>Prüfungsgebühren: CHF 800</li>
      <li>Administrationskosten: CHF 300</li>
    ...
    <table>
      ...
      <tbody>
        <tr><td>Zu lange Bindung (> 3 Jahre)</td><td>Zu restriktiv, verletzt Berufsfreiheit</td><td>Oft ungültig</td></tr>
        <tr><td>'Lebenslange' Bindung</td><td>Unzumutbar</td><td>UNGÜLTIG</td></tr>
        <tr><td>Keine Degression</td><td>Zu hart, nicht gerechtfertigt</td><td>Oft angefochten</td></tr>
        <tr><td>Rückzahlung auch wenn AG kündigt</td><td>Gegen Treu & Glauben</td><td>UNGÜLTIG</td></tr>
      </tbody>
    </table>
  ...
  'beruflich/finanzierung/steuer-hack-weiterbildung': `
    ...
    <table>
      ...
      <tbody>
        <tr><td>Zürich (ZH)</td><td>CHF 12'000–12'400</td><td>Professionelle Aus- & Weiterbildung</td></tr>
        <tr><td>Bern (BE)</td><td>CHF 12'000–15'000</td><td>Berufsausbildung, Fortbildung</td></tr>
        <tr><td><strong>Basel-Stadt (BS)</strong></td><td><strong>CHF 19'100 (!)</strong></td><td>Höchster Abzug der Vergleichskantone</td></tr>
        <tr><td>St. Gallen (SG)</td><td>CHF 12'000</td><td>Berufsorientierte Fortbildung</td></tr>
        <tr><td>Luzern (LU)</td><td>CHF 12'000</td><td>Aus- und Weiterbildung</td></tr>
        <tr><td>Aargau (AG)</td><td>CHF 12'000</td><td>Berufsausbildung, -fortbildung</td></tr>
      </tbody>
    </table>
  ...
  'beruflich/finanzierung/alternative-finanzierungswege': `
    ...
    <ul>
      ...
      <li>Bestätigung Einnahmen (Steuererklärung, Lohnzettel)</li>
      <li>Kurs-Kostenvoranschlag</li>
    ...
    <ul>
      ...
      <li>Kanton Zürich - Fonds & Stiftungen (zh.ch)</li>
  ...
  'beruflich/karriere/berufliche-standortbestimmung': `
    ...
    <table>
      <thead>
        <tr><th>Element</th><th>Inhalt</th><th>Ergebnis</th></tr>
      </thead>
      <tbody>
        <tr><td>Job-Analyse</td><td>Werdegang, aktuelle Position, Zufriedenheit</td><td>Klare Bestandsaufnahme</td></tr>
        <tr><td>Kompetenz-Erfassung</td><td>Fähigkeiten, Kenntnisse, Stärken</td><td>Realistische Selbstsicht</td></tr>
        <tr><td>Arbeitsmarkt-Check</td><td>Marktfähigkeit, Trends, Chancen</td><td>Chancen-orientierte Planung</td></tr>
      </tbody>
    </table>
  ...
  'beruflich/karriere/spezialisierung-vs-generalisierung': `
    ...
    <table>
      ...
      <tbody>
        <tr><td>IT-Manager</td><td>Projektmanagement (Expert)</td><td>Technologie, Change Mgmt</td></tr>
        <tr><td>HR-Spezialist</td><td>Talent Development</td><td>Recht (OR), Lohnmanagement</td></tr>
      </tbody>
    </table>
  ...
  'beruflich/karriere/linkedin-optimierung': `
    ...
    <table>
      ...
      <tbody>
        <tr><td>1. Headline aktualisieren mit neuer Spezialisierung</td><td>"Online-Manager | Digital Strategie & Content Marketing"</td></tr>
        <tr><td>2. Summary: Weiterbildung in Narrative einweben</td><td>"Nach 8 Jahren im Sales neu in Digital Marketing mit Kursen in SEO, Analytics und Content Strategie."</td></tr>
        <tr><td>3. 'Open to Work' spezifizieren</td><td>"Open to Work: Product Manager Rollen mit Analytics-Fokus"</td></tr>
        <tr><td>4. Kurse konkret benennen (nicht vage)</td><td>"Google Analytics 4 Zertifikat (Januar 2026)" nicht "Digital Skills"</td></tr>
        <tr><td>5. Endorsements + Empfehlungen aktivieren</td><td>Nach Kursen die neuen Skills von Kurskollegen endorsen lassen</td></tr>
      </tbody>
    </table>
  ...
  'beruflich/karriere/gehaltsverhandlung-nach-kurs': `
    ...
    <table>
      ...
      <tbody>
        <tr><td>"Das war deine Entscheidung, nicht unsere"</td><td>"Stimmt, aber die Resultate, die ich seit dem Kurs liefere, sind UNSER gemeinsamer Erfolg."</td></tr>
        <tr><td>"Nicht budgetiert für deine Rolle"</td><td>"Könnten diese neuen Skills nicht meine aktuelle Rolle ergänzen?"</td></tr>
  ...
  'beruflich/karriere/quereinstieg-40-plus': `
    ...
    <table>
      ...
      <tbody>
        <tr><td>Gesundheit</td><td>Grosser Bedarf, viele Umschulungsprogramme</td><td>Care-Worker, Arztassistentin</td></tr>
        <tr><td>IT & Tech</td><td>Skills > Diplome, Remote-Modell älterfreundlich</td><td>QA, Support, PM-Rollen</td></tr>
        <tr><td>Soziales</td><td>Lebenserfahrung wertvoll, Fachkräftemangel</td><td>Sozialarbeiter, Mentor, Coach</td></tr>
      </tbody>
    </table>
    ...
    <h3>"Ich verdiene weniger, wenn ich wechsle"</h3>
    <p>Ja, wahrscheinlich 20-40% weniger anfangs. Aber: Zukunfts-Math zeigt, dass du nach 5-7 Jahren wieder oben bist.</p>
  ...
  'beruflich/karriere/soft-skills-karriere-turbo': `
    ...
    <table>
      ...
      <tbody>
        <tr><td>48-Stunden-Regel</td><td>Rückschlag: 0-2h emotional, 2-24h Info sammeln, 24-48h Action Plan</td></tr>
        <tr><td>Locus of Control</td><td>90% Energie auf INTERNE Faktoren (wie ich reagiere), 10% auf externe (Wirtschaft)</td></tr>
        <tr><td>Antifragilität</td><td>Nach Krisen fragen: Was habe ich gelernt? Bin ich für die NÄCHSTE besser vorbereitet?</td></tr>
      </tbody>
    </table>
 ...
 * @param {string} categorySlug - e.g., 'beruflich'
 * @param {string} clusterSlug - e.g., 'finanzierung'
 * @param {string} articleSlug - e.g., 'vollkostenrechnung-weiterbildung'
 * @returns {string|null} HTML content or null if not found
 */
export function getArticleContent(categorySlug, clusterSlug, articleSlug) {
  const key = `${categorySlug}/${clusterSlug}/${articleSlug}`;
  return RATGEBER_CONTENT[key] || null;
}
