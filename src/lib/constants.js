...
    // SEARCH FILTERS
    ...
    faq_q7: "Can I cancel a booking?", faq_a7: "Yes. Fixed-date bookings can be cancelled free of charge via the dashboard up to 14 days before the course date. Flex bookings can be cancelled free of charge within 7 days after payment. After the automatic cancellation window, you can send a goodwill request to the provider via the dashboard. The provider may decide on a 0%, 25%, 50% or 100% refund and can add an explanatory message.",
...
    // SEARCH FILTERS
    ...
    faq_q7: "Kann ich eine Buchung stornieren?", faq_a7: "Ja. Terminbuchungen kannst du bis 14 Tage vor dem Termin kostenlos direkt im Dashboard stornieren. Flexible Buchungen kannst du innerhalb von 7 Tagen nach der Zahlung kostenlos stornieren. Nach Ablauf dieser automatischen Frist kannst du im Dashboard eine Kulanzanfrage an den Anbieter senden. Der Anbieter kann 0 %, 25 %, 50 % oder 100 % Rückerstattung bewilligen und optional eine Nachricht mitschicken.",
...
    // SEARCH FILTERS
    ...
    faq_q7: "Puis-je annuler une réservation?", faq_a7: "Oui. Les réservations à date fixe peuvent être annulées gratuitement depuis le tableau de bord jusqu'à 14 jours avant le cours. Les réservations flexibles peuvent être annulées gratuitement dans les 7 jours suivant le paiement. Ensuite, vous pouvez envoyer une demande de geste commercial au prestataire via le tableau de bord. Le prestataire peut décider d'un remboursement de 0 %, 25 %, 50 % ou 100 %.",
