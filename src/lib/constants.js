...
export const SEGMENT_CONFIG = {
  ...
  beruflich: {
    ...
    heroBg: "/images/platform/hero-professional.svg",
    color: 'blue',
    bgLight: 'bg-blue-50',
    bgSolid: 'bg-blue-500',
    text: 'text-blue-600',
  ...
  privat_hobby: {
    ...
    heroBg: "/images/platform/hero-private.svg",
    color: 'primary',
    bgLight: 'bg-primaryLight',
    bgSolid: 'bg-primary',
    text: 'text-primary',
  ...
  kinder_jugend: {
    ...
    heroBg: "/images/platform/hero-kids.svg",
    color: 'emerald',
    bgLight: 'bg-emerald-50',
    bgSolid: 'bg-emerald-500',
    text: 'text-emerald-600',
...
    // SEARCH FILTERS
    ...
    faq_q7: "Kann ich eine Buchung stornieren?", faq_a7: "Ja – innerhalb von 7 Tagen nach der Zahlung kannst du kostenlos direkt im Dashboard stornieren (sofern der Kurs nicht innerhalb von 7 Tagen beginnt). Danach gilt die Plattform-Rückerstattungsstaffel: bis 14 Tage vor Kursbeginn 100%, bis 3 Tage vor Kursbeginn 50%, danach keine Rückerstattung. Wenn kein Storno-Button mehr angezeigt wird, kontaktiere bitte info@kursnavi.ch.",
