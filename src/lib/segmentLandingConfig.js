...
export const SEGMENT_LANDING_CONFIG = {
  beruflich: {
    ...
    themen: [
      ...
      {
        slug: 'bildung-pruefung',
        label: 'Bildung & Prüfung',
        icon: '📋',
        desc: 'Eidgenössische Prüfungen, Zulassungen & Bildungsabschlüsse',
        isThemenwelt: false,
        href: '/thema/beruflich/bildung-pruefung',
      ...
      {
        slug: 'finanzen-rechnungswesen',
        label: 'Finanzen & Rechnungswesen',
        icon: '💰',
        desc: 'Buchhaltung, Controlling, Steuern & Finanzplanung',
        isThemenwelt: false,
        href: '/thema/beruflich/finanzen-rechnungswesen',
  ...
  privat_hobby: {
    ...
    themen: [
      ...
      {
        slug: 'tiere-hundeschule',
        label: 'Tiere & Hundeschule',
        icon: '🐕',
        desc: 'Hundeschule, Tierverhalten & Training',
        isThemenwelt: false,
        href: '/thema/privat-hobby/tiere-hundeschule',
  ...
  kinder_jugend: {
    ...
    themen: [
      ...
      },
      {
        ...
        label: 'Ferienkurse & Camps',
        icon: '☀️',
        desc: 'Spannende Erlebnisse & neue Freundschaften in den Ferien',
        isThemenwelt: false,
        href: '/thema/kinder-jugend/ferienkurse-camps',
        image: 'https://images.unsplash.com/photo-1471922694854-ff1b63b20054?auto=format&fit=crop&q=80&w=800',
      },
      ...
      },
      {
        ...
        icon: '📖',
        desc: 'Sprachkurse, schulische Förderung & Lernunterstützung',
        isThemenwelt: false,
        href: '/thema/kinder-jugend/sprachen-lernen',
